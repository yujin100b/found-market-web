      ...
      news: [
        {
          ...
          media: "Platum",
          short:
            "로컬 농식품 스타트업 ‘더로컬프로젝트’가 임팩트투자사 엠와이소셜컴퍼니(MYSC)로부터 시드투자를 유치했다. 더로컬프로젝트는 전국 로컬 네트워킹과 인프라를 활용해 로컬제품을 대중에게 알리고 스케일업을 도모하고 있다. 회사의 첫 프로젝트인 제주 진피녹차는 시장에서 좋은 반응을 얻고 있다.  ",
        },
        {
          id: 2,
          link: "https://platum.kr/archives/157737",
